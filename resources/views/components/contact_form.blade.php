    ...
    <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <form method="post" action="/!/forms/contact_form" class="space-y-8">
            ...
            <div>
                ...
                <input type="email" name="email" id="email" class="block p-2.5 w-full text-sm text-typo-primary bg-gray-50 rounded-lg border border-gray-300 shadow-sm" placeholder="name@flowbite.com" required>
            </div>
            <div>
